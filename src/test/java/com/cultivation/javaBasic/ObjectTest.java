...
class ObjectTest {
    ...
    void should_get_initialization_ordering() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String[] expected = new String[4];
        expected[0] = "Field Initializer";
        expected[1] = "Initialization Block";
        expected[2] = "Constructor with argument";
        expected[3] = "Default constructor";
        // --end-->
